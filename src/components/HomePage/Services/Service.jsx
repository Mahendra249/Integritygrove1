      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-lg-4">
            ...
            >
              <div className="icon-img-50 mb-40">
                <img loading="lazy" src="assets/imgs/serv-icons/0.png" alt="" />
              </div>
              ...
              <div className="crv-more">
                <a href="page-services.html" className="mt-30 ls1 fz-12 text-u">
                  Read More
                  <svg
                    width={18}
                    height={18}
          ...
          <div className="col-lg-4">
            ...
            >
              <div className="icon-img-50 mb-40">
                <img loading="lazy" src="assets/imgs/serv-icons/1.png" alt="" />
              </div>
          ...
          <div className="col-lg-4">
            ...
            >
              <div className="icon-img-50 mb-40">
                <img loading="lazy" src="assets/imgs/serv-icons/2.png" alt="" />
              </div>
