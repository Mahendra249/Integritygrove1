    ...
    <main>
      <header className="page-header blog-header section-padding pb-0">
        ...
        <div
          ...
          data-background="https://ui-themez.smartinnovates.net/items/geekfolio/dark/assets/imgs/blog/b2.jpg"
          style={{
            backgroundImage:
              'url("https://ui-themez.smartinnovates.net/items/geekfolio/dark/assets/imgs/blog/b2.jpg")',
          }}
        >
          ...
          <div className="main-post">
                  ...
                  <div className="col-lg-10">
                    <div className="text">
                      <div className="d-flex align-items-center">
                        ...
                        <p>
                          new report said earlier this week that Apple is
                          working on a brand new laptop. A trusted Apple insider
                          with a proven track record confirmed that Apple is
            ...
            <div className="next-prv-post flex mt-50">
              ...
              >
                <a href="blog-details.html">
                  <span className="fz-12 text-u ls1 main-color mb-15">
                    Next Post <i className="pe-7s-angle-right" />
                  </span>
                  <h6 className="fw-600 fz-16">
                    ...
                    <div className="col-lg-9">
                      <div className="flex">
                        ...
                        <div className="cont">
                          ...
                          <p className="fz-14">
                            Ut elementum turpis lorem, id vulputate risus
                            consequat vitae. Morbi eget urna imperdiet,
