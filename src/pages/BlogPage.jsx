          ...
          <div className="row">
            <div className="col-lg-8">
              <div className="caption">
                ...
                <h1 className="fz-80">Latest News.</h1>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-lg-4 col-md-6">
              <div className="item mb-50">
                <div className="img">
                  <img src="https://ui-themez.smartinnovates.net/items/geekfolio/dark/assets/imgs/blog/h2.jpg" alt />
                  <div className="date">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="item mb-50">
                <div className="img">
                  <img src="https://ui-themez.smartinnovates.net/items/geekfolio/dark/assets/imgs/blog/h3.jpg" alt />
                  <div className="date">
                    <a href="blog-details.html">30 august 2021</a>
                  </div>
                </div>
                <div className="cont mt-30">
                  <h6>
                    <a href="blog-details.html">
                      We create some things for your success in future growth
                    </a>
                  </h6>
                  <a href="blog-details.html" className="mt-20 ls1 sub-title">
                    Read More
            ...
            <div className="col-lg-4 col-md-6">
              <div className="item md-mb50">
                <div className="img">
                  <img src="https://ui-themez.smartinnovates.net/items/geekfolio/dark/assets/imgs/blog/h4.jpg" alt />
                  <div className="date">
                    <a href="blog-details.html">30 august 2021</a>
                  </div>
                </div>
